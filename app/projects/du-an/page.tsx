...
export default function DuAnPage() {
  ...
  const fetchProjects = async () => {
    setLoading(true)
    try {
      const response = await fetch('/api/projects?type=commercial')
  ...
  return (
    <div className="min-h-screen bg-macos-bg-secondary">
      <PageHeader
        title="Dự Án"
        subtitle={`${projects.length} dự án thương mại`}
        icon={<BuildingOfficeIcon className="w-8 h-8 text-ios-blue" strokeWidth={1.8} />}
        actions={
          <motion.button
            whileTap={{ scale: 0.95 }}
            onClick={() => router.push('/projects/upload?type=du-an')}
      ...
      <div className="px-4 lg:px-8 py-6 lg:py-8">
        ...
        >
          <div className="relative">
            ...
            <input
              ...
              placeholder="Tìm kiếm dự án thương mại..."
        ...
        {loading ? (
          ...
          >
            <BuildingOfficeIcon className="w-16 h-16 text-ios-gray-400 mx-auto mb-4" strokeWidth={1.5} />
