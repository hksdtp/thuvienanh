...
export default function KhachHangLePage() {
  ...
  const fetchProjects = async () => {
    setLoading(true)
    try {
      const response = await fetch('/api/projects?type=residential')
  ...
  return (
    <div className="min-h-screen bg-macos-bg-secondary">
      <PageHeader
        ...
        icon={<UserGroupIcon className="w-8 h-8 text-ios-blue" strokeWidth={1.8} />}
        actions={
          <motion.button
            whileTap={{ scale: 0.95 }}
      ...
      <div className="px-4 lg:px-8 py-6 lg:py-8">
        ...
        >
          <div className="relative">
            ...
            <input
              ...
              placeholder="Tìm kiếm dự án khách hàng lẻ..."
        ...
        {loading ? (
          ...
          >
            <UserGroupIcon className="w-16 h-16 text-ios-gray-400 mx-auto mb-4" strokeWidth={1.5} />
            <h3 className="text-lg font-semibold text-macos-text-primary mb-2">
              Chưa có dự án khách hàng lẻ nào
            </h3>
